<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a class="nav-link" href="#"><i class="far fa-square"></i> <span>Data Category</span></a></li>
        <li><a class="nav-link" href="#"><i class="far fa-square"></i> <span>Data Product</span></a></li>
